...
class Routes(
  ...
  def documentation = List(
    ...
    ("""POST""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """register""", """controllers.Application.register"""),
  ...
  // @LINE:8
  private[this] lazy val controllers_Application_register1_route = Route("POST",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    case controllers_Application_register1_route(params) =>
      call { 
        controllers_Application_register1_invoker.call(Application_1.register)
      }
